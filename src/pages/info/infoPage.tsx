...
// Aquí importarías tu objeto infoData que ya tienes
...
const { slug } = useParams<{ slug: string }>(); // Tipar el parámetro
const key = slug || ''; 
const linkInscripcion = 'https://forms.gle/ix6vheEM1KsucNv19';
// Buscamos la data y le decimos que puede ser cualquier cosa (any)
